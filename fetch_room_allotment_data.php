...
while($row =oci_fetch_array($query,OCI_ASSOC))
{
	...
	$sub_array[] = '<a href="edit_room_allotment.php?student_id='.$row['STUDENT_ID'].'&course_code='.$row['COURSE_CODE'].'&exam_date='.$row['EXAM_DATE'].'"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-plus-square"></i></button></a>';
	$data[] = $sub_array; 
}
$count_rows = oci_num_rows($query);
$output = array(
