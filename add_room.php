                                ...
                                <div class="input-states">
                                    ...
                                    <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="room_no" class="form-control" placeholder=" Name" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="number" min="0" name="capacity" class="form-control" placeholder=" Capacity" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" min="0" name="location" class="form-control" placeholder=" Location" required="">
                                                </div>
                                            </div>
                                        </div>
