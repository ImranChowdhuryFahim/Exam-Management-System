                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST" action="goto_view_attendance_by_date.php" name="userform" enctype="multipart/form-data">
                                    <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Room No</label>
                                                <div class="col-sm-9">
                                                   <select name="room_no" id="course_code" class="form-control" required="">
                                                    <option value=" ">--Room No--</option>
                                                     <?php  
                          $sql2 = "select room_no from invigilates where teacher_id='" . $_SESSION['id'] . "'";
