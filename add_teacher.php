                                    ...
                                    <form class="form-horizontal" method="POST" action="pages/save_teacher.php" name="teacherform" enctype="multipart/form-data">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  name="teacher_name"  class="form-control" id="event" onkeydown="return alphaOnly(event);" placeholder="Name" required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="teacher_email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  placeholder="Email" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="teacher_contact_no" class="form-control" pattern="^(?:(?:\+|00)88|01)?\d{11}$"  placeholder="Contact Number" required>
                                                </div>
                                            </div>
                                        </div>
