...
if(isset($_POST["btn_update"]))
{
    if($_POST["password"]!='')
    {
        if($_POST['password']==$_POST['cpassword'])
        {
            ...
            extract($_POST);
            $q1="update student set student_name='" . $student_name . "', student_email='" . $student_email . "', student_contact_no='" . $student_contact_no . "' where student_id='" . $_GET['id'] . "'";
            $q2="update login set password='" . $password . "' where email='" . $student_email ."'";
                                    ...
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" name="studentform">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="student_name" class="form-control" placeholder="Name" id="event" onkeydown="return alphaOnly(event);" value="<?php echo $name; ?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="student_email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  placeholder="Email" value="<?php echo $email; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="student_contact_no" class="form-control" pattern="^(?:(?:\+|00)88|01)?\d{11}$"  placeholder="Contact Number" value="<?php echo $contact_no; ?>" required>
                                                </div>
                                            </div>
                                        </div>
